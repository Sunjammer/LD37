...
vm_Instruction.LDA = function(v) { var $x = ["LDA",0,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.LDX = function(v) { var $x = ["LDX",1,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.LDY = function(v) { var $x = ["LDY",2,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.STA = function(v) { var $x = ["STA",3,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.STX = function(v) { var $x = ["STX",4,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.STY = function(v) { var $x = ["STY",5,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.PHA = ["PHA",6];
vm_Instruction.PHA.toString = $estr;
vm_Instruction.PHA.__enum__ = vm_Instruction;
vm_Instruction.PLA = ["PLA",7];
vm_Instruction.PLA.toString = $estr;
vm_Instruction.PLA.__enum__ = vm_Instruction;
vm_Instruction.TAX = ["TAX",8];
vm_Instruction.TAX.toString = $estr;
vm_Instruction.TAX.__enum__ = vm_Instruction;
vm_Instruction.TXA = ["TXA",9];
vm_Instruction.TXA.toString = $estr;
vm_Instruction.TXA.__enum__ = vm_Instruction;
vm_Instruction.TAY = ["TAY",10];
vm_Instruction.TAY.toString = $estr;
vm_Instruction.TAY.__enum__ = vm_Instruction;
vm_Instruction.TYA = ["TYA",11];
vm_Instruction.TYA.toString = $estr;
vm_Instruction.TYA.__enum__ = vm_Instruction;
vm_Instruction.TXY = ["TXY",12];
vm_Instruction.TXY.toString = $estr;
vm_Instruction.TXY.__enum__ = vm_Instruction;
vm_Instruction.TYX = ["TYX",13];
vm_Instruction.TYX.toString = $estr;
vm_Instruction.TYX.__enum__ = vm_Instruction;
vm_Instruction.SUB = function(v) { var $x = ["SUB",14,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.ADD = function(v) { var $x = ["ADD",15,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.SLI = ["SLI",16];
vm_Instruction.SLI.toString = $estr;
vm_Instruction.SLI.__enum__ = vm_Instruction;
vm_Instruction.SLP = function(v) { var $x = ["SLP",17,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.BNE = function(b,pos) { var $x = ["BNE",18,b,pos]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.BEQ = function(b,pos) { var $x = ["BEQ",19,b,pos]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.BLT = function(b,pos) { var $x = ["BLT",20,b,pos]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.BGT = function(b,pos) { var $x = ["BGT",21,b,pos]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.JMP = function(v) { var $x = ["JMP",22,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.JSR = function(v) { var $x = ["JSR",23,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.RTS = ["RTS",24];
vm_Instruction.RTS.toString = $estr;
vm_Instruction.RTS.__enum__ = vm_Instruction;
vm_Instruction.RTI = ["RTI",25];
vm_Instruction.RTI.toString = $estr;
vm_Instruction.RTI.__enum__ = vm_Instruction;
vm_Instruction.DMA = function(v) { var $x = ["DMA",26,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.AND = function(v) { var $x = ["AND",27,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.IOR = function(v) { var $x = ["IOR",28,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.XOR = function(v) { var $x = ["XOR",29,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.LSH = function(v) { var $x = ["LSH",30,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.RSH = function(v) { var $x = ["RSH",31,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.BRK = ["BRK",32];
vm_Instruction.BRK.toString = $estr;
vm_Instruction.BRK.__enum__ = vm_Instruction;
vm_Instruction.NOP = ["NOP",33];
vm_Instruction.NOP.toString = $estr;
vm_Instruction.NOP.__enum__ = vm_Instruction;
vm_Instruction.OUT = function(v) { var $x = ["OUT",34,v]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
vm_Instruction.MEM = function(a,b) { var $x = ["MEM",35,a,b]; $x.__enum__ = vm_Instruction; $x.toString = $estr; return $x; };
		...
		case 18:
			...
			case 1:
				...
				if(a[3]) {
					...
					tmp4 = this.MEMCTRL[1][l9];
				}
				break;
			case 2:
				tmp4 = this.RAM[3] + (a[2] - 1);
				break;
			case 3:
				tmp4 = this.RAM[0];
				break;
		...
		case 19:
			...
			case 1:
				...
				if(a1[3]) {
					...
					tmp6 = this.MEMCTRL[1][l11];
				}
				break;
			case 2:
				tmp6 = this.RAM[3] + (a1[2] - 1);
				break;
			case 3:
				tmp6 = this.RAM[0];
				break;
		...
		case 20:
			...
			case 1:
				...
				if(a2[3]) {
					...
					tmp8 = this.MEMCTRL[1][l13];
				}
				break;
			case 2:
				tmp8 = this.RAM[3] + (a2[2] - 1);
				break;
			case 3:
				tmp8 = this.RAM[0];
				break;
		...
		case 21:
			...
			case 1:
				...
				if(a3[3]) {
					...
					tmp10 = this.MEMCTRL[1][l15];
				}
				break;
			case 2:
				tmp10 = this.RAM[3] + (a3[2] - 1);
				break;
			case 3:
				tmp10 = this.RAM[0];
				break;
		...
		case 35:
			...
			case 1:
				...
				if(b[3]) {
					...
					tmp15 = this.MEMCTRL[1][l27];
				}
				break;
			case 2:
				tmp15 = this.RAM[3] + (b[2] - 1);
				break;
			case 3:
				tmp15 = this.RAM[0];
				break;
...
vm_Value.Const = function(v) { var $x = ["Const",0,v]; $x.__enum__ = vm_Value; $x.toString = $estr; return $x; };
vm_Value.Location = function(v,ram) { var $x = ["Location",1,v,ram]; $x.__enum__ = vm_Value; $x.toString = $estr; return $x; };
vm_Value.Relative = function(v) { var $x = ["Relative",2,v]; $x.__enum__ = vm_Value; $x.toString = $estr; return $x; };
vm_Value.AReg = ["AReg",3];
vm_Value.AReg.toString = $estr;
vm_Value.AReg.__enum__ = vm_Value;
vm_Value.XReg = ["XReg",4];
vm_Value.XReg.toString = $estr;
vm_Value.XReg.__enum__ = vm_Value;
vm_Value.YReg = ["YReg",5];
vm_Value.YReg.toString = $estr;
